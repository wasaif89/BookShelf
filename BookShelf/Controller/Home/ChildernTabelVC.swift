...
//
//class ChildernTabelVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "ChildrensBooksCell") as! ChildrensBooksCell
...
//                            if (doc.data()["section"] as? String == "Childern Book") {
